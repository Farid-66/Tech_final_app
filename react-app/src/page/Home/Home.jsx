...
function Home({ cart }) {
  ...
  const fetchToken = async () => {
    const { token } = await commerce.customer.getToken(token).then((jwt) => setUserID(jwt));
  }
  // ========================================
  ...
  useEffect(() => {
    commerce.products.list({ category_slug: ['clients'] })
      .then((product) => setClients(product.data));
